...
@Component({
  selector: 'app-ranking-listing',
  templateUrl: './ranking-listing.component.html',
  styleUrls: ['./ranking-listing.component.scss']
})
export class RankingListingComponent implements OnInit {
  imageUrl=base;
  rankings:any = [];
  totalItems:any;
  availableDriver:any;
  ...
  getallRanking(){
    this.api.getRankings(this.filterBody).subscribe((response:any)=>{
